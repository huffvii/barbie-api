...
app.get('/api/:barbieMovie', (request, response)=>{
    const barbieMovies = request.params.barbieMovie.toLowerCase()
    if(movies[barbieMovies]){
        response.json(movies[barbieMovies])
    }else{
